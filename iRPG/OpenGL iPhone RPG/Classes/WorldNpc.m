...
@synthesize npcNum, hp, mp, originalMap,originalTile, currentMap, currentTile, permanent,npcTimer,moveNpcTimer, movedToDir;
- (id)init 
{
	//if (self = [super init])
	return self;
...
{   
	...
	[coder encodeObject: [NSNumber numberWithBool:permanent] forKey:@"permanent" ];
} 
...
- (id) initWithCoder: (NSCoder *) coder
{
	...
	permanent = [[coder decodeObjectForKey:@"permanent"] boolValue];
    return self;
}
-(void)dealloc {
	[super dealloc];
